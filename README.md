...
- Refine Planet Attributes and Randomness Algorithm
...
- Modernize the CSS and styling on the pages we have so far
- Add options to delete planets, update profile information (i can do this too)
- There should probably a nav bar in the base.html page that also includes a logout button if logged in
